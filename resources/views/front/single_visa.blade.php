...
@section('content')
    <main class="main">
        ...
        <div class="site-breadcrumb" style="background: url(assets/img/team/visa.jpg)">
            <div class="container">
                <h2 class="breadcrumb-title">Visa Single</h2>
                <ul class="breadcrumb-menu">
                    <li><a href="index.html">Home</a></li>
                    <li class="active">Visa Single</li>
                </ul>
            </div>
        </div>
        <!-- breadcrumb end -->
        ...
        <!-- visa-single -->
        <div class="visa-single py-100">
            <div class="container">
                <div class="row g-4">
                    <div class="col-lg-4">
                        <div class="visa-sidebar">
                            <div class="widget">
                                <h4 class="title">Visa Type</h4>
                                <div class="visa-list">
                                    ...
                                    <a href="#" class="list-item">
                                        <span>Migrate Visa</span>
                                        <i class="far fa-angle-double-right"></i>
                                    </a>
                                </div>
                            </div>
                            <div class="visa-banner" style="background-image: url(assets/img/visa/banner.jpg)">
                                <div class="banner-content">
                                    <span>Get Visa Service</span>
                                    <h1>Feel Free To Contact Us</h1>
                                    <a href="#" class="theme-btn2">Contact Us<i
                    ...
                    <div class="col-lg-8">
                        <div class="visa-details">
                            <div class="mb-30">
                                <img src="assets/img/visa/single.jpg" alt="">
                            </div>
                            <div class="content">
                                <h3 class="mb-20">Working Visa</h3>
                                <p class="mb-20">
                                ...
                                <div class="row mb-20">
                                    <div class="col-md-4">
                                        <div class="visa-single-item">
                                            <img src="assets/img/icon/agent.svg" alt="">
                                            <h5>Fill In The Required Form</h5>
                                    ...
                                    <div class="col-md-4">
                                        <div class="visa-single-item">
                                            ...
                                            <h5>Submit Your Original Documents</h5>
                                            <p>There are many variations of passages available but the majority suffered.
                                            </p>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="visa-single-item">
                                            ...
                                            <h5>Get The Visa Resource Material</h5>
                                            <p>There are many variations of passages available but the majority suffered.
                                            </p>
                                        </div>
                                    </div>
                                ...
                                <div class="mt-4">
                                    <h3 class="mb-3">Why Choose Our Business Visa ?</h3>
